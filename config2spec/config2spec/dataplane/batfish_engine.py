...
class BatfishEngine(object):
    ...
    def get_forwarding_graphs(self, fib_file_name, vrf="default"):
        ...
        for fec in fecs:
            ...
            foundPrefix['prefix'].append(str(prefix))
            foundPrefix['fec'].append(str(fec))
        ...
        dictToCsv(foundPrefix, 'finPrefix.csv')
    ...
    def build_forwarding_graph(self, prefix, blocked_edges, fibs):
        ...
        for router in self.nodes:
            ...
            # for debug
            for fib_prefix in fibs[router].fib.keys():
                if fib_prefix not in generatedFibPrefix['prefix']:
                    generatedFibPrefix['prefix'].append(str(fib_prefix))
        ...
        dictToCsv(generatedFibPrefix, 'generatedFibPrefix.csv')
