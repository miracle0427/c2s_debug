...
public interface FlatJuniperParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FlatJuniperParser#s_vlans_tail}.
	 * @param ctx the parse tree
	 */
	void enterS_vlans_tail(FlatJuniperParser.S_vlans_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link FlatJuniperParser#s_vlans_tail}.
	 * @param ctx the parse tree
	 */
	void exitS_vlans_tail(FlatJuniperParser.S_vlans_tailContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FlatJuniperParser#roir_inet}.
	 * @param ctx the parse tree
	 */
	void enterRoir_inet(FlatJuniperParser.Roir_inetContext ctx);
	/**
	 * Exit a parse tree produced by {@link FlatJuniperParser#roir_inet}.
	 * @param ctx the parse tree
	 */
	void exitRoir_inet(FlatJuniperParser.Roir_inetContext ctx);
	/**
	 * Enter a parse tree produced by {@link FlatJuniperParser#roir_null}.
	 * @param ctx the parse tree
	 */
	void enterRoir_null(FlatJuniperParser.Roir_nullContext ctx);
	/**
	 * Exit a parse tree produced by {@link FlatJuniperParser#roir_null}.
	 * @param ctx the parse tree
	 */
	void exitRoir_null(FlatJuniperParser.Roir_nullContext ctx);
	/**
