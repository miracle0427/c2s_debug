...
public class Main {
  ...
  public static Map<String, String> getQuestionTemplates(boolean verbose) {
    ...
    Path myDebugPath = Paths.get("/home/wyf/orgin-old-version-batfish/questions");
    System.out.println("QuestionTemplateDirs: " + myDebugPath + " verbose: " + verbose);
    List<Path> questionTemplateDir = new ArrayList<>();
    questionTemplateDir.add(myDebugPath);
