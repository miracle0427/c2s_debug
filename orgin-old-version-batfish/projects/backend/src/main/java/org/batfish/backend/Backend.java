...
public class Backend {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("at main start");
  ...
  private static String initMinesweeper(Request req, Response res) {
    ...
    System.out.println("initMinesweeper");
    String answer;
    Path basePath = null;
  ...
  private static String getDataplane(Request req, Response res) {
    long startTime = System.currentTimeMillis();
    System.out.println("getDataplane");
    ...
    DataPlane dp = null;
    try {
      System.out.println("topology.getEdges().size(): "+topology.getEdges().size());
    ...
    System.out.println("DP computation took " + (System.currentTimeMillis() - startTime) + ".");
